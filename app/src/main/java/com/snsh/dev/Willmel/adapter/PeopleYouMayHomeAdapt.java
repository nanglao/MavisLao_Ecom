...
public class PeopleYouMayHomeAdapt extends RecyclerView.Adapter<PeopleYouMayHomeAdapt.MyViewHolder> {
    ...
    public PeopleYouMayHomeAdapt(List<BestDealModel> moviesList) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.layout_people_you_may, parent, false);
